                        ...
                        <div class="form-body">
                            <div class="form-grid">
                                ...
                                <div class="form-row">
                                    ...
                                    <div>
                                        <select class="form-control" name="type" required>
                                            <option value="Call" ${act.type == 'Call' ? 'selected' : ''}>Call</option>
                                            <option value="Meeting" ${act.type == 'Meeting' ? 'selected' : ''}>Meeting</option>
                                            <option value="Email" ${act.type == 'Email' ? 'selected' : ''}>Email</option>
                                            <option value="Task" ${act.type == 'Task' ? 'selected' : ''}>Task</option>
                                            <option value="Note" ${act.type == 'Note' ? 'selected' : ''}>Note</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" name="title" 
                                               placeholder="Nhập tiêu đề công việc..." required value="${act.title}">
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div>
                                        <textarea class="form-control" name="description" placeholder="Mô tả chi tiết...">${act.description}</textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="priority-group">
                                        <div class="priority-option">
                                            <input type="radio" id="p-high" name="priority" value="High" class="priority-radio" 
                                                   ${act.priority == 'High' ? 'checked' : ''}>
                                            <label for="p-high" class="priority-label priority-high">
                                                <span class="priority-icon">🔴</span> High
                                            </label>
                                        </div>
                                        <div class="priority-option">
                                            <input type="radio" id="p-medium" name="priority" value="Medium" class="priority-radio" 
                                                   ${empty act.priority || act.priority == 'Medium' ? 'checked' : ''}>
                                ...
                                <div class="form-row full-width">
                                    ...
                                    <div>
                                        ...
                                        <input type="file" name="attachments" class="file-input" id="fileInput"
                                               multiple
